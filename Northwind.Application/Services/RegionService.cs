...
namespace Northwind.Application.Services
{
    public class RegionService : IRegionService
    {
        ...
        public async Task<PagedResponse<RegionDto>> GetAsync(IPaginationQuery paginationQuery)
        {
            var (totalItems, regions) = await _unitOfWork.Regions.GetAsync(paginationQuery);
