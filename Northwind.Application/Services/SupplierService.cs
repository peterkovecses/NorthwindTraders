...
namespace Northwind.Application.Services
{
    public class SupplierService : ISupplierService
    {
        ...
        private readonly SupplierPredicateBuilder _predicateBuilder;

        public SupplierService(IUnitOfWork unitOfWork, IMapper mapper, SupplierPredicateBuilder predicateBuilder)
        {
