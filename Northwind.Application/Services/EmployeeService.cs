...
namespace Northwind.Application.Services
{
    public class EmployeeService : IEmployeeService
    {
        ...
        public async Task<PagedResponse<EmployeeDto>> GetAsync(IPaginationQuery paginationQuery)
        {
            var (totalItems, employees) = await _unitOfWork.Employees.GetAsync(paginationQuery);
